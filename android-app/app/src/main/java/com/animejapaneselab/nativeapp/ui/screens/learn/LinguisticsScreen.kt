...
internal fun LinguisticsScreen(
    ...
    Column(modifier.fillMaxSize()) {
        Column(
            ...
            VolumeSwitch(
                options = listOf("第一巻 アニメの台詞", "第二巻 基礎"),
                selectedIndex = if (track == LinguisticsTrack.AnimeCorpus) 0 else 1,
                onSelect = { onTrackSelected(if (it == 0) LinguisticsTrack.AnimeCorpus else LinguisticsTrack.Foundation) },
            )
