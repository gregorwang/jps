/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e6e76aec4a9fcd78480eab9674abc876)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	SENTENCES: KVNamespace;
	DB: D1Database;
	EVALUATION_RATE_LIMITER: RateLimit;
	AI: Ai;
	ENVIRONMENT: "production";
	AI_GATEWAY_ID: "my-ai-gateway";
	ALLOWED_ORIGINS: "https://anime-japanese-lab.ishallnotwant123.workers.dev,http://localhost:5173,http://127.0.0.1:5173";
	AUTH_REQUIRED: "true";
	MAX_AUDIO_BYTES: "1572864";
	MAX_REQUEST_BYTES: "1638400";
	ATTEMPT_TTL_DAYS: "7";
	SCORER_VERSION: "ja-mora-v1.1.0";
	NOVA_CONFIDENCE_THRESHOLD: "0.82";
	FALLBACK_ALIGNMENT_MIN: "60";
	FALLBACK_ALIGNMENT_MAX: "88";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AI_GATEWAY_ID" | "ALLOWED_ORIGINS" | "AUTH_REQUIRED" | "MAX_AUDIO_BYTES" | "MAX_REQUEST_BYTES" | "ATTEMPT_TTL_DAYS" | "SCORER_VERSION" | "NOVA_CONFIDENCE_THRESHOLD" | "FALLBACK_ALIGNMENT_MIN" | "FALLBACK_ALIGNMENT_MAX" | "UNKNOWN_RATIO_THRESHOLD" | "RELIABILITY_THRESHOLD" | "AUTH_HMAC_SECRET">> {}
}
