...
const priorFiles = Array.from({ length: 10 }, (_, index) => index + 1).flatMap(
  (batch) => [
    `archive-content-sources/rezero-exercise-regen-2026-07-27/batch${batch}_vocab_linguistic.json`,
    `archive-content-sources/rezero-exercise-regen-2026-07-27/batch${batch}_grammar_sentence_linguistic.json`,
  ],
);
