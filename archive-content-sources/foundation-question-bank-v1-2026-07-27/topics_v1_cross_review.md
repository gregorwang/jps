...
- 生成文件：`archive-content-sources/foundation-question-bank-v1-2026-07-27/topics_v1_generation.json`
...
- 修订方式：`archive-content-sources/foundation-question-bank-v1-2026-07-27/topics_v1_review_overlay.json` 中按 `topic_key` 整条替换；没有追加 ID
