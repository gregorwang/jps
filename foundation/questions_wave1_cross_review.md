...
- 生成文件：`foundation/questions_wave1_generation.json`
- Review overlay：`foundation/questions_wave1_review_overlay.json`
- 生成 QA：`foundation/questions_wave1_generation_qa.md`
- 主题契约：`foundation/topics_v1_effective.json`
...
```text
node scripts/validate-foundation-content.mjs pack foundation/questions_wave1_generation.json foundation/questions_wave1_review_overlay.json
```
