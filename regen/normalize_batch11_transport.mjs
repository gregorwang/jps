...
const vocabPath = "regen/batch11_vocab_linguistic.json";
const grammarPath = "regen/batch11_grammar_sentence_linguistic.json";
const sentencePath = "regen/batch11_sentence_linguistic_overlay.json";
...
const sentencePart1 = await readJsonWithTrailingCommaCleanup(
  "regen/batch11_sentence_part1.overlay.json",
);
const sentencePart2 = await readJsonWithTrailingCommaCleanup(
  "regen/batch11_sentence_part2.overlay.json",
);
