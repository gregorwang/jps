...
const configs = {
  meta9: {
    ...
    chunkSize: 20,
    baseFiles: ["regen/batch9_meta_exercises.json"],
    generationOverlay: "regen/generation_overlay_meta_exercises_batch9.json",
    reviewOverlay: "regen/review_overlay_meta_exercises_batch9.json",
    reviewReport: "regen/cross_review_meta_exercises_batch9.md",
  },
  meta10: {
    kind: "exercise",
    expectedRows: 42,
    ...
    chunkSize: 21,
    baseFiles: ["regen/batch10_meta_exercises.json"],
    generationOverlay: "regen/generation_overlay_meta_exercises_batch10.json",
    reviewOverlay: "regen/review_overlay_meta_exercises_batch10.json",
    reviewReport: "regen/cross_review_meta_exercises_batch10.md",
  },
  linguistic11: {
    kind: "linguistic",
    expectedRows: 80,
    ...
    reviewOverlay: "regen/review_overlay_linguistic_batch11.json",
    reviewReport: "regen/cross_review_linguistic_batch11.md",
  },
  linguistic12: {
    kind: "linguistic",
    expectedRows: 80,
    ...
    reviewOverlay: "regen/review_overlay_linguistic_batch12.json",
    reviewReport: "regen/cross_review_linguistic_batch12.md",
  },
  letter35_37: {
    kind: "exercise",
    expectedRows: 120,
    ...
    generationOverlay: "regen/generation_overlay_exercises_letter_batches35_37.json",
    reviewOverlay: "regen/review_overlay_exercises_letter_batches35_37.json",
    reviewReport: "regen/cross_review_exercises_letter_batches35_37.md",
  },
  letter38_40: {
    kind: "exercise",
    expectedRows: 120,
    ...
    chunkSize: 40,
    baseFiles: [
      "regen/batch38_exercises_letter.json",
      "regen/batch39_exercises_letter.json",
      "regen/batch40_exercises_letter.json",
    ],
    generationOverlay: "regen/generation_overlay_exercises_letter_batches38_40.json",
    reviewOverlay: "regen/review_overlay_exercises_letter_batches38_40.json",
    reviewReport: "regen/cross_review_exercises_letter_batches38_40.md",
  },
};
...
if (!config) {
  fail(`usage: node regen/prepare_reviewed_transport.mjs <${Object.keys(configs).join("|")}> [--summary|--chunk N|--write-effective PATH]`);
}
